...
public class TestConstructorWith3Parameters {
	...
	public void testShouldNotAllowNegativeDigit3() {
		...
		// with a bad first digit
		assertThrows(IllegalArgumentException.class, () -> {
			new HexadecimalNumber(0, 0, -1);
		});
	}

	@Test
	public void testShouldNotAllowDigit3Over15() {
		// Arrange, Act, and Assert: create the HexadecimalNumber object
		// with a bad first digit
		assertThrows(IllegalArgumentException.class, () -> {
			new HexadecimalNumber(0, 0, 16);
		});
	}
	...
	public void testShouldCreateValidHexadecimalNumber() {
		...
		HexadecimalNumber theNumber = new HexadecimalNumber(2, 3, 5);
