package edu.westga.scribble.model;

import acm.graphics.GTurtle;

/**
 * ScribbleTurtle represents a graphical turtle that can move around on the screen,
...
public class Turtle extends GTurtle {
	...
	public static final double INITIAL_TURTLE_SPEED = 0.6;
	public static final int INITIAL_SIZE = 50;

	private boolean tailDown;

	/**
	 * Creates a new ScribbleTurtle object of size 50 at location 0, 0.
	 * 
	 * @precondition none
